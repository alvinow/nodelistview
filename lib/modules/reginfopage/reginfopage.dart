...
class RegInfoPage extends StatefulWidget {
  RegInfoPage({required this.state});
...
Widget organizationLogoWidget() {
  return Container(
      height: 80,
      child: Image.asset('assets/logo/logo_itb99_circle.png'));
}
...
Widget displayNodeContent(VwNode? node) {
  if (node != null) {
    ...
    VwFieldValue? nimFieldValue = node.content!.rowData!.getFieldByName("nim");
    ...
    if (nameFieldValue != null &&
      ...
      try {
        ...
        if (eventNode != null) {
          ...
          if(noteFieldName!=null && noteFieldName.valueString!=null)
            {
              lNoteWidget= Container(margin: EdgeInsets.fromLTRB(20, 0, 20, 0), child:Text(
                  noteFieldName.valueString!));
            }
      ...
      Widget backgroundTicket=Image.asset("assets/image/background_tiket_99_F_Nite_Fest.jpg");
      ...
      Widget ticketWidget= Container(
        ...
        children: [
            ...
            return Container(
              ...
              //constraints: BoxConstraints(maxHeight: 200),
                ...
                child: QrImageView(
                  ...
                  data: AppConfig.baseUrl+"/#/tiket/" + Uri.encodeComponent(regCodeFieldValue!.valueString!),
          ...
          Text(
            ...
            style: TextStyle(backgroundColor: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),
          ),
          Text(
